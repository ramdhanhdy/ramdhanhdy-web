        ...
        <div className="max-w-2xl mx-auto w-full flex flex-col gap-10 sm:gap-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-zinc-800">
            <div className="min-w-0">
              ...
              <a href="mailto:hello@example.com" className="text-xl sm:text-2xl break-all hover:text-neon transition-colors duration-300">
                hello@example.com
              </a>
            </div>
            <div>
              ...
              <div className="flex flex-col gap-2">
                <a href="#" className="text-xl sm:text-2xl hover:text-neon transition-colors duration-300">Twitter</a>
                <a href="#" className="text-xl sm:text-2xl hover:text-neon transition-colors duration-300">LinkedIn</a>
                <a href="#" className="text-xl sm:text-2xl hover:text-neon transition-colors duration-300">GitHub</a>
              </div>
            </div>
          </div>
        </div>
